...
Contains all relevant files for blogpost: [Backup Alcatel-Lucent Enterprise Omniswitch AOS6 & AOS8 using Ansible](https://netdevops.be/alcatel-lucent-enterprise-omniswitch-aos6-aos8-ansible-backup/)
